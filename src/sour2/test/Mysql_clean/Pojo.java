...
/*
排序的时候，如果要做为键值，就必须实现WritableComparable接口
 */
public class Pojo implements Writable, DBWritable, WritableComparable<Pojo> {
    int id; // 编号
    String city; //城市
    String company; // 公司名
    ...
    public Pojo(int id, String city, String company, String companySize, String companyType, String edulevel, String emplType, String extractSkillTag, String jobName, String salary, String welfare, String workingExp, String addtime, String numbers) {
        this.id = id;
        this.city = city;
    ...
    public void write(DataOutput out) throws IOException {
        ...
        out.writeUTF(this.addtime);
        out.writeUTF(this.numbers);
    }
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        this.addtime = in.readUTF();
        this.numbers = in.readUTF();
    }
    ...
    public void write(PreparedStatement statement) throws SQLException {
        ...
        statement.setString(13,this.addtime);
        statement.setString(14,this.numbers);
    }
    ...
    public void readFields(ResultSet resultSet) throws SQLException {
        ...
        this.addtime = resultSet.getString(13);
        this.numbers = resultSet.getString(14);
    }

    @Override
    public String toString() {
        return id + "|"+city+ "|"+company+ "|"+companySize+ "|"+companyType+"|"+edulevel+ "|"+emplType+ "|"+extractSkillTag+ "|"+jobName+ "|"+salary+ "|"+welfare+ "|"+workingExp+"|"+addtime+"|"+numbers;
    }
